...
Type=simple
User=ubuntu
WorkingDirectory=/home/ubuntu/devin-investment-os
EnvironmentFile=-/home/ubuntu/devin-investment-os/.env
ExecStart=/home/ubuntu/devin-investment-os/.venv/bin/streamlit run app.py --server.port 8501 --server.address 0.0.0.0
Restart=always
RestartSec=5
